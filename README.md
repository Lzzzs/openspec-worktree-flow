...
It is designed for teams that want to run multiple requests in parallel without mixing proposal work, implementation work, and cleanup work in the same checkout.

## What problem it solves

When multiple requests are active in the same repository, teams often run into the same failures:
...
2. get approval
3. create one isolated branch and worktree for implementation
